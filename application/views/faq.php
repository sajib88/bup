    ...
    <div class="col-md-4">
        <div class="sticky">
                    ...
                    <ul class="list-unstyled list-info">
                        <li>
                            ...
                            <div class="info">
                                ...
                                <p class="no-mrg-btm ">New User? Start with the basic</p>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <a href="#ask-2" class="card mrg-btm-15 scroll-to">
                <div class="card-block padding-25">
                    <ul class="list-unstyled list-info">
                        <li>
                        <span class="thumb-img pdd-top-10">
                            <i class="ti ti-crown text-success font-size-30"></i>
                        </span>
                            <div class="info">
                                <b class="text-dark font-size-22">Administrative</b>
                                <p class="no-mrg-btm">Know what role of an Administrator</p>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <div class="card-block padding-25">
                    <ul class="list-unstyled list-info">
                        ...
                        <span class="thumb-img pdd-top-10">
                            ...
                            <div class="info">
                                <b class="text-dark font-size-22">About Search</b>
                                <p class="no-mrg-btm">Know about 'Smart and Advanced' Searching</p>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <a href="#ask-4" class="card mrg-btm-15 scroll-to">
                <div class="card-block padding-25">
                    <ul class="list-unstyled list-info">
                        <li>
                        <span class="thumb-img pdd-top-10">
                            <i class="ti-files text-warning font-size-30"></i>
                        </span>
                            <div class="info">
                                <b class="text-dark font-size-22">Controlling Content Version</b>
                                <p class="no-mrg-btm">Know more about managing contents properly</p>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <a href="#ask-5" class="card mrg-btm-15 scroll-to">
                <div class="card-block padding-25">
                    <ul class="list-unstyled list-info">
                        <li><span class="thumb-img pdd-top-10">
                            <i class="ti-shield text-danger font-size-30"></i>
                        </span>
                            <div class="info">
                                <b class="text-dark font-size-22">Content Security</b>
                                <p class="no-mrg-btm">Know more about managing contents</p>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <div class="mrg-top-30">
                    <div id="accordion-ask-1" class="accordion border-less" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion-ask-1" href="#collapse-ask-1.1">
                                        <span>How To upload contents</span>
                                        <i class="icon ti-arrow-circle-down"></i>
                                    </a>
                                </h4>
                            </div>
                            <div id="collapse-ask-1.1" class="collapse panel-collapse">
                                <div class="panel-body">
                                    <p>
                                        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                                    </p>
                            ...
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion-ask-1" href="#collapse-ask-2">
                                        <span>How to set attributes to the uploading contents, is it mendatory?</span>
                                        <i class="icon ti-arrow-circle-down"></i>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion-ask-1" href="#collapse-ask-3">
                                        <span>How to Batch Uploading?</span>
                                        <i class="icon ti-arrow-circle-down"></i>
                                    </a>
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion-ask-1" href="#collapse-ask-3.1">
                                        <span>Does this system supports multiple types of batch uploading, how?</span>
                                        <i class="icon ti-arrow-circle-down"></i>
                                    </a>
                                </h4>
                            </div>
                            <div id="collapse-ask-3.1" class="collapse panel-collapse">
                                <div class="panel-body">
                                    <p>
                                        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                                    </p>
                            ...
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion-ask-2" href="#collapse-ask-4">
                                        <span>How to create new user</span>
                                        <i class="icon ti-arrow-circle-down"></i>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion-ask-2" href="#collapse-ask-5">
                                        <span>How to add privileges to users</span>
                                        <i class="icon ti-arrow-circle-down"></i>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion-ask-3" href="#collapse-ask-7">
                                        <span>How to find a content which has been uploaded long time ago?</span>
                                        <i class="icon ti-arrow-circle-down"></i>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion-ask-3" href="#collapse-ask-8">
                                        <span>Can a content be searched by specific attributes, how?</span>
                                        <i class="icon ti-arrow-circle-down"></i>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion-ask-3" href="#collapse-ask-9">
                                        <span>Can a content be modified once it is uploaded, how?</span>
                                        <i class="icon ti-arrow-circle-down"></i>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion-ask-4" href="#collapse-ask-10">
                                        <span>What to do if previous and latest updated both contents are required?</span>
                                        <i class="icon ti-arrow-circle-down"></i>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion-ask-4" href="#collapse-ask-11">
                                        <span>Can a content be got back once it is deleted?</span>
                                        <i class="icon ti-arrow-circle-down"></i>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion-ask-4" href="#collapse-ask-12">
                                        <span>Can a content hide from being found</span>
                                        <i class="icon ti-arrow-circle-down"></i>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion-ask-5" href="#collapse-ask-13">
                                        <span>Can a content uploaded by other user be modified or be deleted?</span>
                                        <i class="icon ti-arrow-circle-down"></i>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion-ask-5" href="#collapse-ask-14">
                                        <span>Can a content be protected from being found by other?</span>
                                        <i class="icon ti-arrow-circle-down"></i>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading" role="tab">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion-ask-5" href="#collapse-ask-15">
                                        <span>How to know about a content that is being viewed or modified or deleted by whose or whom</span>
                                        <i class="icon ti-arrow-circle-down"></i>
                                    </a>
                                </h4>
                            </div>
